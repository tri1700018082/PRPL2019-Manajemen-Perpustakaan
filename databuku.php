...
<tr>
     ...
     while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a href='editbuku.php?kodebuku=$user_data[kodebuku]'>Edit</a> | <a href='deletebuku.php?kodebuku=$user_data[kodebuku]'>Delete</a></td></tr>";
    }
    ?>
      ...
      <div class="feat_prod_box_details">
        ...
        <td><input type="text" class="contact_input" name="katbuku"></td>
            </div>
            <div class="form_row">
              <td><label class="contact"> <strong>Nama Buku</strong></label></td>
        <td><input type="text" class="contact_input" name="namabuku"></td>
            </div>
            <div class="form_row">
              <td><label class="contact"> <strong>Jumlah Buku</strong></label></td>
        <td><input type="int" class="contact_input" name="jumlahbuku"></td>
            </div>
