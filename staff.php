...
?>
     ...
     while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a href='editstaff.php?idstaff=$user_data[idstaff]'>Edit</a> | <a href='deletestaff.php?idstaff=$user_data[idstaff]'>Delete</a></td></tr>";
    }
    ?>
      ...
      <div class="feat_prod_box_details">
        ...
        <td><input type="int" class="contact_input" name="idstaff"></td>
            </div>
            <div class="form_row">
              <td><label class="contact"> <strong>Nama Pustakawan</strong></label></td>
        <td><input type="text" class="contact_input" name="namastaff"></td>
            </div>
