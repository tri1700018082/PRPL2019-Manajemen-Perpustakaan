...
?>
     ...
     while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a href='editpeminjam.php?idpeminjam=$user_data[idpeminjam]'>Edit</a> | <a href='deletepinjam.php?idpeminjam=$user_data[idpeminjam]'>Delete</a></td></tr>";
    }
    ?>
      ...
      <div class="feat_prod_box_details">
        ...
        <td><input type="text" class="contact_input" name="namapeminjam"></td>
            </div>
            <div class="form_row">
              <td><label class="contact"> <strong>No HP</strong></label></td>
        <td><input type="int" class="contact_input" name="nohp"></td>
            </div>
